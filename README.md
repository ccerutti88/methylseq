...
**NB:** All information about the *nf-core/methylseq pipeline* are available here: https://nf-co.re/methylseq/1.6
...
```
**NB:** Adapt the code with your work directories, paths, email,...
...
**NB:** Details about pipeline parameters are available here: https://nf-co.re/methylseq/1.6/parameters
...
**NB:** Details about the output produced by the pipeline are available here: https://nf-co.re/methylseq/1.6/output
