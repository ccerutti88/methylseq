...
[NB1]: <All information about the *nf-core/methylseq pipeline* are available here: https://nf-co.re/methylseq/1.6>
...
```
[NB2]: <Adapt the code with your work directories, paths, email,...>
...
[NB3]: <Details about slurm parameters are available here: https://slurm.schedmd.com/sbatch.html>
...
[NB4]: <Details about pipeline parameters are available here: https://nf-co.re/methylseq/1.6/parameters>
...
[NB5]: <Details about the output produced by the pipeline are available here: https://nf-co.re/methylseq/1.6/output>
